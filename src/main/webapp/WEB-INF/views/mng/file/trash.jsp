...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">임시 휴지통</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('mng_file_trash_table', '임시휴지통')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="search_box" class="form-select form-select-solid" data-control="select2"
                                                    ...
                                                    <option value="REASON">삭제사유</option>
                                                </select>
                                                <!--end::Select2-->
                                            </div>
                                            <%--end::검색구분--%>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_file_trash_search()" class="btn btn-primary me-5">Search</button>
                                                <button type="button" onclick="f_file_trash_search_condition_init()" class="btn btn-secondary me-5">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="mng_file_trash_table">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    <th class="text-center min-w-50px">번호</th>
                                                    <th>SEQ</th>
                                                    <th class="text-center min-w-200px">메뉴위치</th>
                                                    <th class="text-center min-w-200px">삭제사유</th>
                                                    <th class="text-center min-w-150px">삭제일시</th>
    ...
    <script src="/js/mng/trash.js?ver=<%=System.currentTimeMillis()%>"></script>
