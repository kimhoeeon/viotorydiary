...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('mng_education_payment_table', '결제_환불현황')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="search_box" class="form-select form-select-solid" data-control="select2"
                                                    ...
                                                    <option value="PHONE">신청자연락처</option>
                                                </select>
                                                <!--end::Select2-->
                                            </div>
                                            <%--end::검색구분--%>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_education_payment_search()" class="btn btn-primary me-5">Search</button>
                                                <button type="button" onclick="f_education_payment_search_condition_init()" class="btn btn-secondary me-5">
                                        ...
                                        <div class="card-toolbar flex-row-fluid gap-5">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="condition_status" class="form-select form-select-solid" data-control="select2"
                                                        ...
                                                        data-placeholder="- 상태 -" onchange="f_education_payment_search()">
                                                    <option></option>
                                            ...
                                            <%--<div class="ms-auto d-flex align-items-center gap-2 gap-lg-3">
                                                ...
                                                <!--begin::결제 상태 변경 버튼-->
                                                <button type="button" id="pay_status_btn" class="btn btn-danger" data-bs-target="#kt_modal_pay_status">
                                                    <i class="ki-duotone ki-arrows-circle fs-3">
                                                        <i class="path1"></i>
                                                        <i class="path2"></i>
                                                    </i> 결제 상태 변경</button>
                                                <!--end::입금 상태 변경 버튼-->
                                                <!--begin::등록-->
                                                <a href="javascript:void(0);" onclick="f_education_payment_modify_init_set('');" class="btn btn-primary ms-auto">등록</a>
                                                <!--end::등록-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="mng_education_payment_table">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    <%--<th class="w-10px pe-2">
                                                        <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                            <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                                   data-kt-check-target="#mng_education_payment_table .form-check-input" value="1"/>
                                                        </div>
                                                    </th>--%>
                                                    ...
                                                    <th class="text-center min-w-75px">결제상태</th>
                                                    <th class="text-center min-w-150px">취소일시</th>
    ...
    <!--begin::Modal - 수정이력-->
    <div class="modal fade" id="kt_modal_pay_status" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" style="background-color: #1e1e2d;">
                    <!--begin::Modal title-->
                    <h2 style="color: #FFFFFF;">결제 상태 변경</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    ...
                    <form id="modal_form" method="post" onsubmit="return false;">
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">결제 상태 변경할 내역</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8 d-flex align-items-center">
                                <span class="payment_list"></span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">결제 상태</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8 d-flex align-items-center">
                                <!--begin::Select2-->
                                <select id="md_pay_status_sel" class="form-select form-select-solid" data-control="select2"
                                        data-hide-search="true" data-allow-clear="true"
                                        data-placeholder="- 결제 상태 -">
                                    <option></option>
                                    <option value="" disabled>- 결제 상태 -</option>
                                    <option value="결제대기">결제대기</option>
                                    <option value="결제완료">결제완료</option>
                                    <option value="수강확정">수강확정</option>
                                    <option value="수강완료">수강완료</option>
                        ...
                        <div class="row mb-8 d-none">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">환불-사유</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8 d-flex align-items-center">
                                <input type="text" id="refund_reason" name="refund_reason" class="form-control form-control-solid-bg" placeholder="환불-사유"/>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                    ...
                    <div class="col-lg-12 d-flex justify-content-center">
                        ...
                        <div class="ms-10">
                            <!--begin::button-->
                            <a onclick="f_pay_status_btn_yn()" class="btn btn-primary">승인</a>
                            <!--end::button-->
                        </div>
                        <!--end::Col-->
                    </div>
    ...
    <div class="modal fade" id="kt_modal_modify_history" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" style="background-color: #1e1e2d;">
                    <!--begin::Modal title-->
                    <h2 style="color: #FFFFFF;">결제/환불 상세보기</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                        <i class="ki-duotone ki-cross fs-1">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-6">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg" id="md_member_name" placeholder="신청자 성명" readonly>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-6">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg" id="md_member_phone" placeholder="신청자 연락처" readonly>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-6">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg" id="md_train_name" placeholder="교육명" readonly>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-6">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg" id="md_pay_status" placeholder="결제상태" readonly>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-6">
                                <!--begin::Label-->
                                <label class="form-label">환불사유</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <div id="md_refund_reason" class="form-control form-control-solid-bg resize-none h-150px overflow-y-auto" readonly></div>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
    ...
    <script src="/js/mng/payment.js?ver=<%=System.currentTimeMillis()%>"></script>
