...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                    ...
                                    <form id="dataForm" method="post" onsubmit="return false;">
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input type="text" id="email" name="email" value="${info.email}" class="form-control form-control-lg form-control-solid-bg" placeholder="이메일"/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">수신 동의 여부</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8 d-flex align-items-center">
                                                    <label class="me-5"><input type="radio" name="sendYn" value="Y" class="form-check-input form-control-solid-bg" <c:if test="${info.sendYn == 'Y' or empty info}">checked</c:if> > 동의</label>
                                                    <label><input type="radio" name="sendYn" value="N" class="form-check-input form-control-solid-bg" <c:if test="${info.sendYn == 'N'}">checked</c:if> > 미동의</label>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <div class="card-footer d-flex justify-content-between py-6 px-9">
                                        <div>
                                            <a href="/mng/newsletter/subscriber.do" class="btn btn-info btn-active-light-info" id="kt_list_btn">목록</a>
                                        </div>
                                        <div>
                                            <button type="button" onclick="f_newsletter_subscriber_modify_init_set('${info.seq}')" class="btn btn-danger btn-active-light-danger me-2">변경내용취소</button>
                                            <button type="button" onclick="f_newsletter_subscriber_save('${info.seq}')" class="btn btn-primary btn-active-light-primary" id="kt_save_submit">변경내용저장</button>
                                        </div>
                                    </div>
                                    <!--end::Actions-->
                                </div>
    ...
    <script src="/js/mng/subscriber.js?ver=<%=System.currentTimeMillis()%>"></script>
    <!--end::Custom Javascript-->
