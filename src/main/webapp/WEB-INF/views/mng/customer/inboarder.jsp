...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">선내기 기초정비실습 과정</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('mng_customer_inboarder_table', '자가정비_선내기')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                                    ...
                                    <!--begin::Export dropdown-->
                                    <button type="button" onclick="f_customer_inboarder_detail_excel_download('mng_customer_inboarder_table', '자가정비_선내기_상세')" class="btn btn-warning btn-active-light-warning" data-kt-menu-placement="bottom-end">
                                        <i class="ki-duotone ki-exit-down fs-2">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_customer_inboarder_search()" class="btn btn-primary me-5">Search</button>
                                                <button type="button" onclick="f_customer_inboarder_search_condition_init()" class="btn btn-secondary me-5">
                                        ...
                                        <div class="card-toolbar flex-row-fluid gap-5">
                                            ...
                                            <div class="w-100 mw-175px">
                                                ...
                                                <select id="condition_year" class="form-select form-select-solid" data-control="select2"
                                                        ...
                                                        data-placeholder="- 연도 -" onchange="f_customer_inboarder_search()">
                                                    <option></option>
                                            ...
                                            <div class="w-100 mw-175px">
                                                ...
                                                <select id="condition_time" class="form-select form-select-solid" data-control="select2"
                                                        data-hide-search="true" data-allow-clear="true"
                                                        data-placeholder="- 차시 -" onchange="f_customer_inboarder_search()">
                                                    <option></option>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    ...
                    <div class="col-lg-12 d-flex justify-content-center">
                        ...
                        <div class="ms-10">
                            <!--begin::File upload-->
                            <a onclick="f_customer_inboarder_train_change_btn()" class="btn btn-primary">변경</a>
                            <!--end::File upload-->
                        </div>
                        <!--end::Col-->
                    </div>
    ...
    <script src="/js/mng/inboarder.js?ver=<%=System.currentTimeMillis()%>"></script>
