...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">세일요트 기초정비실습 과정</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('mng_customer_sailyacht_table', '자가정비_세일요트')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                                    ...
                                    <!--begin::Export dropdown-->
                                    <button type="button" onclick="f_customer_sailyacht_detail_excel_download('mng_customer_sailyacht_table', '자가정비_세일요트_상세')" class="btn btn-warning btn-active-light-warning" data-kt-menu-placement="bottom-end">
                                        <i class="ki-duotone ki-exit-down fs-2">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_customer_sailyacht_search()" class="btn btn-primary me-5">Search</button>
                                                <button type="button" onclick="f_customer_sailyacht_search_condition_init()" class="btn btn-secondary me-5">
                                            ...
                                            <%--<div class="ms-auto">
                                                <!--begin::등록-->
                                                <a href="javascript:void(0);" onclick="f_customer_sailyacht_modify_init_set('');" class="btn btn-primary ms-auto">등록</a>
                                                <!--end::등록-->
                                            </div>--%>
                                        </div>
                                        <!--end::Card title-->
                                        ...
                                        <div class="card-toolbar flex-row-fluid gap-5">
                                            ...
                                            <div class="w-100 mw-175px">
                                                ...
                                                <select id="condition_year" class="form-select form-select-solid" data-control="select2"
                                                        ...
                                                        data-placeholder="- 연도 -" onchange="f_customer_sailyacht_search()">
                                                    <option></option>
                                            ...
                                            <div class="w-100 mw-175px">
                                                ...
                                                <select id="condition_time" class="form-select form-select-solid" data-control="select2"
                                                        data-hide-search="true" data-allow-clear="true"
                                                        data-placeholder="- 차시 -" onchange="f_customer_sailyacht_search()">
                                                    <option></option>
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="condition_apply_status" class="form-select form-select-solid" data-control="select2"
                                                        data-hide-search="true" data-allow-clear="true"
                                                        data-placeholder="- 신청상태 -" onchange="f_customer_sailyacht_search()">
                                                    <option></option>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="mng_customer_sailyacht_table">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    <th class="w-10px pe-2">
                                                        <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                            <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                                   data-kt-check-target="#mng_customer_sailyacht_table .form-check-input" value="1"/>
                                                        </div>
                                                    </th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    ...
                    <div class="col-lg-12 d-flex justify-content-center">
                        ...
                        <div class="ms-10">
                            <!--begin::File upload-->
                            <a onclick="f_customer_sailyacht_train_change_btn()" class="btn btn-primary">변경</a>
                            <!--end::File upload-->
                        </div>
                        <!--end::Col-->
                    </div>
    ...
    <script src="/js/mng/sailyacht.js?ver=<%=System.currentTimeMillis()%>"></script>
