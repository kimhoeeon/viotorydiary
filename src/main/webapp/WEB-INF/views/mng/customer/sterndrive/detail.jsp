...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">스턴드라이브 정비 전문가과정</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                                ...
                                                <div class="col-lg-8 d-flex flex-column">
                                                    ...
                                                    <label class="mb-3">
                                                        <input type="checkbox" name="trainUnderstand" value="2" class="form-check-input form-control-solid-bg me-2"
                                                               <c:if test="${fn:contains(info.trainUnderstand, '2')}">checked</c:if> disabled/> 스턴드라이브 정비 분야에 경력이 있으신 분
                                                    </label>
                                                    <label class="mb-3">
                                                        <input type="checkbox" name="trainUnderstand" value="3" class="form-check-input form-control-solid-bg me-2"
                                                               <c:if test="${fn:contains(info.trainUnderstand, '3')}">checked</c:if> disabled/> 경력이 없으나 스턴드라이브 정비 기술 습득을 원하시는 분
                                                    </label>
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <div class="card-footer d-flex justify-content-between py-6 px-9">
                                        <div>
                                            <a href="/mng/customer/sterndrive.do" class="btn btn-info btn-active-light-info" id="kt_list_btn">목록</a>
                                        </div>
                                            <%--<div>
    ...
    <script src="/js/mng/sterndrive.js?ver=<%=System.currentTimeMillis()%>"></script>
    <!--end::Custom Javascript-->
