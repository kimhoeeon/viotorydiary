                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-10 d-flex align-items-center">
                                                    <label class="me-5">
                                                        <input type="radio" name="applyDay" value="6/28(토)" class="form-check-input form-control-solid-bg"
                                                               <c:if test="${info.applyDay eq '6/28(토)'}">checked</c:if> disabled/> 6/28(토)
                                                    </label>
                                                    <label class="me-5">
                                                        <input type="radio" name="applyDay" value="8/30(토)" class="form-check-input form-control-solid-bg"
                                                               <c:if test="${info.applyDay eq '8/30(토)'}">checked</c:if> disabled/> 8/30(토)
                                                    </label>
                                                    <label class="me-5">
                                                        <input type="radio" name="applyDay" value="10/18(토)" class="form-check-input form-control-solid-bg"
                                                               <c:if test="${info.applyDay eq '10/18(토)'}">checked</c:if> disabled/> 10/18(토)
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="applyDay" value="11/10(월)" class="form-check-input form-control-solid-bg"
                                                               <c:if test="${info.applyDay eq '11/10(월)'}">checked</c:if> disabled/> 11/10(월)
                                                    </label>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <div class="card-footer d-flex justify-content-between py-6 px-9">
                                        <div>
                                            <a href="/mng/customer/famtourout.do" class="btn btn-info btn-active-light-info" id="kt_list_btn">목록</a>
                                        </div>
                                            <%--<div>
