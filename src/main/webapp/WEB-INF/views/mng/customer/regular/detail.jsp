...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">상시 사전 신청</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                    ...
                                    <form id="dataForm" method="post" onsubmit="return false;">
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input type="text" id="name" name="name" class="form-control form-control-lg form-control-solid-bg" placeholder="이름" value="${memberInfo.name}"/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input type="text" id="phone" name="phone" class="form-control form-control-lg form-control-solid-bg onlyTel" placeholder="연락처" value="${memberInfo.phone}"/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                                    ...
                                                    <div class="input-group">
                                                        <select id="year_select" name="birthYear" class="form-select form-control-solid-bg me-4">
                                                            ...
                                                            <c:forEach var="year" begin="1950" end="${sysYear}" step="1">
                                                                <option value="${idx}" <c:if test="${memberInfo.birthYear eq idx}">selected</c:if>><c:out value="${idx}"/> 년</option>
                                                        ...
                                                        <select id="month_select" name="birthMonth" class="form-select form-control-solid-bg me-4">
                                                            ...
                                                            <c:forEach var="month" begin="1" end="12" step="1">
                                                                <option value="${month}" <c:if test="${memberInfo.birthMonth eq month}">selected</c:if>><c:out value="${month}"/> 월</option>
                                                            </c:forEach>
                                                        </select>
                                                        <select id="day_select" name="birthDay" class="form-select form-control-solid-bg">
                                                            <c:if test="${memberInfo.birthDay eq null}">
                                                                <option value="" selected disabled>일</option>
                                                            </c:if>
                                                            <c:if test="${memberInfo.birthDay ne null}">
                                                                <option value="${memberInfo.birthDay}"><c:out value="${memberInfo.birthDay}"/> 일</option>
                                                            </c:if>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6 required">거주지역</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input type="text" id="region" name="region" class="form-control form-control-lg form-control-solid-bg" placeholder="거주지역" value="${info.region}"/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6 required">1순위 신청분야</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        <select id="first_field_select" name="firstApplicationField" class="form-select form-control-solid-bg me-4">
                                                            <option value="" selected disabled>교육 선택</option>
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6 required">2순위 신청분야</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        <select id="second_field_select" name="secondApplicationField" class="form-select form-control-solid-bg me-4">
                                                            <option value="" selected disabled>교육 선택</option>
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6 required">3순위 신청분야</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        <select id="third_field_select" name="thirdApplicationField" class="form-select form-control-solid-bg me-4">
                                                            <option value="" selected disabled>교육 선택</option>
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">희망 교육 시기</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input type="text" id="desiredEducationTime" name="desiredEducationTime" class="form-control form-control-lg form-control-solid-bg" placeholder="희망 교육 시기" value="${info.desiredEducationTime}"/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">전공</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input type="text" id="major" name="major" class="form-control form-control-lg form-control-solid-bg" placeholder="전공" value="${info.major}"/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-3">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">경험유무</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8 d-flex align-items-center">
                                                    <label class="me-5">
                                                        <input type="radio" name="experienceYn" value="1" class="form-check-input form-control-solid-bg"
                                                               <c:if test="${info.experienceYn eq '1'}">checked</c:if>/> 있음
                                                    </label>
                                                    <label class="me-5">
                                                        <input type="radio" name="experienceYn" value="0" class="form-check-input form-control-solid-bg"
                                                               <c:if test="${info.experienceYn eq '0' or info.experienceYn eq null}">checked</c:if>/> 없음
                                                    </label>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <div class="card-footer d-flex justify-content-between py-6 px-9">
                                        <div>
                                            <a href="/mng/customer/regular.do" class="btn btn-info btn-active-light-info" id="kt_list_btn">목록</a>
                                        </div>
                                        <div>
                                            <button type="button" onclick="f_customer_regular_modify_init_set('${info.seq}')" class="btn btn-danger btn-active-light-danger me-2">변경내용취소</button>
                                            <button type="button" onclick="f_customer_regular_save('${info.seq}')" class="btn btn-primary btn-active-light-primary" id="kt_save_submit">변경내용저장</button>
                                        </div>
                                    </div>
                                    <!--end::Actions-->
                                </div>
    ...
    <script src="/js/mng/regular.js?ver=<%=System.currentTimeMillis()%>"></script>
    <!--end::Custom Javascript-->
