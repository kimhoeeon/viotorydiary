                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <form id="dataForm" method="post" onsubmit="return false;">
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-2 col-form-label fw-semibold fs-6 required">신청 날짜</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-10 d-flex align-items-center">
                                                    <label class="me-5">
                                                        <input type="radio" name="applyDay" value="6/21(토)" class="form-check-input form-control-solid-bg"
                                                               <c:if test="${info.applyDay eq '6/21(토)'}">checked</c:if> disabled/> 6/21(토)
                                                    </label>
                                                    <label class="me-5">
                                                        <input type="radio" name="applyDay" value="7/25(금)" class="form-check-input form-control-solid-bg"
                                                               <c:if test="${info.applyDay eq '7/25(금)'}">checked</c:if> disabled/> 7/25(금)
                                                    </label>
                                                    <label class="me-5">
                                                        <input type="radio" name="applyDay" value="8/9(토)" class="form-check-input form-control-solid-bg"
                                                               <c:if test="${info.applyDay eq '8/9(토)'}">checked</c:if> disabled/> 8/9(토)
                                                    </label>
                                                    <label class="me-5">
                                                        <input type="radio" name="applyDay" value="9/27(토)" class="form-check-input form-control-solid-bg"
                                                               <c:if test="${info.applyDay eq '9/27(토)'}">checked</c:if> disabled/> 9/27(토)
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="applyDay" value="10/24(월)" class="form-check-input form-control-solid-bg"
                                                               <c:if test="${info.applyDay eq '10/24(월)'}">checked</c:if> disabled/> 10/24(월)
                                                    </label>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <div class="card-footer d-flex justify-content-between py-6 px-9">
                                        <div>
                                            <a href="/mng/customer/famtourin.do" class="btn btn-info btn-active-light-info" id="kt_list_btn">목록</a>
                                        </div>
                                            <%--<div>
