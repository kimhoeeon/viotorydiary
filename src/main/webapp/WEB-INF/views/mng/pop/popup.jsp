                                        ...
                                        <div class="card-toolbar flex-row-fluid gap-5">
                                            ...
                                            <div class="w-100 mw-150px">
                                                <div class="form-check">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" id="condition_use_yn" onchange="f_pop_popup_search()"/>
                                                </div>
                                            </div>
                                            <%--end::환불내역존재--%>
                                            ...
                                            <div class="ms-auto d-flex align-items-center gap-2 gap-lg-3">
                                                ...
                                                <!--begin::등록-->
                                                <a href="javascript:void(0);" onclick="f_pop_popup_modify_init_set('');" class="btn btn-primary ms-auto">등록</a>
                                                <!--end::등록-->
