                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                    ...
                                    <form id="dataForm" method="post" onsubmit="return false;">
                                        ...
                                        <div class="card-header border-0">
                                            ...
                                            <div class="card-title m-0">
                                                <h3 class="fw-bold m-0">SMS 발송</h3>
                                            </div>
                                            <!--end::Card title-->
                                        </div>
                                        <!--end::Card header-->
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row">
                                                <!--begin::Label-->
                                                <label class="col-lg-2 col-form-label fw-semibold fs-6">발송 유형 구분</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-10">
                                                    <select id="sms_gbn_content_select" class="form-select form-select-solid" data-control="select2"
                                                            aria-label="- 발송 유형 -" data-placeholder="- 발송 유형 -"
                                                            data-allow-clear="true" data-hide-search="true">
                                                        <option></option>
                                                        <option disabled>- 기능 선택 -</option>
                                                        <option value="TRAIN">과정별</option>
                                                        <option value="MEMBER">회원별</option>
                                                        <option value="EXCEL">엑셀업로드 일괄발송</option>
                                                    </select>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                        ...
                                        <!--begin::Card body-->
                                        <div id="sms_send_form_train" class="card-body border-top p-9">

                                            <!--begin::Input group-->
                                            <div class="row mb-8">
                                                <!--begin::Label-->
                                                <label class="col-lg-2 col-form-label fw-semibold fs-6">과정 선택</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-10">
                                                    <select id="form_train_gbn" class="form-select form-select-solid" data-control="select2"
                                                            aria-label="- 과정 선택 -" data-placeholder="- 과정 선택 -"
                                                            data-allow-clear="true" data-hide-search="true" onchange="f_train_gbn_sms_yn_target_list(this)">
                                                        <option></option>
                                                        <option disabled>- 과정 선택 -</option>
                                                        ...
                                                        <option value="기초정비교육 (선외기)">기초정비교육 (선외기)</option>
                                                        <option value="기초정비교육 (선내기)">기초정비교육 (선내기)</option>
                                                        <option value="기초정비교육 (세일요트)">기초정비교육 (세일요트)</option>
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-2 col-form-label fw-semibold fs-6">발송 대상</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                        ...
                                                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                            <th class="w-10px pe-2">
                                                                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                                    <input class="form-check-input sms_send_tr_all_check" type="checkbox" data-kt-check="true"
                                                                           data-kt-check-target="#sms_send_form_train_table .form-check-input" value="1"/>
                                                                </div>
                                                            </th>
                                                            ...
                                                            <th>trainSeq</th>
                                                            <th>memberSeq</th>
                                                            <th class="text-center min-w-70px">교육차시</th>
                                                            <th class="text-center min-w-70px">ID</th>
                                                            <th class="text-center min-w-70px">이름(국문)</th>
                                                            <th class="text-center min-w-150px">연락처</th>
                                                            <th class="text-center min-w-70px">신청상태</th>
                                                        </tr>
                                                        </thead>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-10 d-flex align-items-center">
                                                    <input type="text" name="sms_template_title" class="sms_template_title form-control form-control-solid-bg me-3" placeholder="템플릿명" disabled/>
                                                    <select class="sms_template_list form-select form-select-solid" data-control="select2"
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-10 d-flex align-items-center">
                                                    <textarea id="sms_template_train_content" name="sms_template_content" class="sms_template_content form-control form-control-solid-bg resize-none h-300px"
                                            ...
                                            <div class="col-lg-12 d-flex justify-content-end">
                                                <!--begin::Col-->
                                                <div>
                                                    <div id="sms_phone_train_list" class="d-none"></div>
                                                    <!--begin::button-->
                                                    <a onclick="f_smsMng_sms_send('train')" class="btn btn-primary">SMS 발송</a>
                                                    <!--end::button-->
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                        ...
                                        <!--begin::Card body-->
                                        <div id="sms_send_form_member" class="card-body border-top p-9">
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-10 d-flex align-items-center">
                                                    <textarea id="sms_template_member_content" name="sms_template_content" class="sms_template_content form-control form-control-solid-bg resize-none h-300px"
                                                              onblur="smsByteChk(this);" onkeyup="smsByteChk(this);" placeholder="SMS 내용"></textarea>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            ...
                                            <div class="col-lg-12 d-flex justify-content-end">
                                                ...
                                                <div>
                                                    <!--begin::button-->
                                                    <a onclick="f_smsMng_sms_send('member')" class="btn btn-primary">SMS 발송</a>
                                                    <!--end::button-->
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                        ...
                                        <!--begin::Card body-->
                                        <div id="sms_send_form_excel" class="card-body border-top p-9">

                                            <!--begin::Col-->
                                            <div class="col-lg-12 d-flex align-items-center justify-content-end gap-lg-3">

                                                <!--begin:Action-->
                                                    <!--begin::Excel import-->
                                                    <a href="javascript:void(0);" class="btn btn-primary btn-active-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_excel_upload">
                                                ...
                                                <div class="col-lg-10 mh-450px overflow-y-scroll">
                                                    ...
                                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="sms_send_form_excel_table">
                                                        ...
                                                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                            <th class="w-10px pe-2">
                                                                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                                    <input class="form-check-input sms_send_ex_all_check" type="checkbox" data-kt-check="true"
                                                                           data-kt-check-target="#sms_send_form_excel_table .form-check-input" value="1"/>
                                                                </div>
                                                            </th>
                                                            <th class="text-center min-w-50px">#</th>
                                                            <th class="text-center min-w-100px">이름</th>
                                                            <th class="text-center min-w-150px">연락처</th>
                                                            <th class="text-center min-w-100px">등급</th>
                                                            <th class="text-center min-w-150px">교육명</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody class="fw-semibold text-gray-600">
                                                        <tr>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-10 d-flex align-items-center">
                                                    <textarea id="sms_template_excel_content" name="sms_template_content" class="sms_template_content form-control form-control-solid-bg resize-none h-300px"
                                                              onblur="smsByteChk(this);" onkeyup="smsByteChk(this);" placeholder="SMS 내용"></textarea>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            ...
                                            <div class="col-lg-12 d-flex justify-content-end">
                                                <!--begin::Col-->
                                                <div>
                                                    <div id="sms_phone_excel_list" class="d-none"></div>
                                                    <!--begin::button-->
                                                    <a onclick="f_smsMng_sms_send('excel')" class="btn btn-primary">SMS 발송</a>
                                                    <!--end::button-->
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <div class="card-footer d-flex justify-content-between py-6 px-9">
                                        <div>
                                            <a href="/mng/smsMng/sms.do" class="btn btn-info btn-active-light-info" id="kt_list_btn">목록</a>
                                        </div>
                                        <%--<div>
