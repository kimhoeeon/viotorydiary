...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">취/창업 현황</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <form id="dataForm" method="post" onsubmit="return false;">
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6 required">취/창업 구분</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <!--begin::Select2-->
                                                    <select id="gbn" name="gbn" class="form-select form-select-solid" data-control="select2" aria-label="- 취/창업 구분 -" data-placeholder="- 취/창업 구분 -" data-hide-search="true">
                                                        <option></option>
                                                        <option disabled>- 취/창업 구분 -</option>
                                                        <c:if test="${info ne null}">
                                                            <option value="취업자" <c:if test="${info.gbn eq '취업자'}">selected</c:if> >취업자</option>
                                                            <option value="창업자" <c:if test="${info.gbn eq '창업자'}">selected</c:if> >창업자</option>
                                                        </c:if>
                                                        <c:if test="${info eq null}">
                                                            <option value="취업자" selected>취업자</option>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input type="text" id="employName" name="employName" class="form-control form-control-lg form-control-solid-bg" placeholder="회사명" value="${info.employName}"/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">대표자</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input type="text" id="employCeo" name="employCeo" class="form-control form-control-lg form-control-solid-bg" placeholder="대표자" value="${info.employCeo}"/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">설립연도</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    ...
                                                    <!--begin::Select2-->
                                                    <select id="employYear" name="employYear" class="form-select form-select-solid" data-control="select2" aria-label="- 설립연도 -" data-placeholder="- 설립연도 -" data-hide-search="true">
                                                        <option></option>
                                                        <option disabled>- 설립연도 -</option>
                                                        <c:forEach var="year" begin="${sysYear-20}" end="${sysYear}" step="1">
                                                            <option value="${idx}" <c:if test="${info.employYear eq idx}">selected</c:if>><c:out value="${idx}"/></option>
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">분야</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input type="text" id="employField" name="employField" class="form-control form-control-lg form-control-solid-bg" placeholder="분야" value="${info.employField}"/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="row">
                                                        <!--begin::Col-->
                                                        <div class="col-lg-10">
                                                            <input type="text" id="employAddress" name="employAddress" class="form-control form-control-lg form-control-solid-bg" placeholder="주소" value="${info.employAddress}" readonly/>
                                                        </div>
                                                        <!--end::Col-->
                                                        <!--begin::Col-->
                                                        <div class="col-lg-2">
                                                            <button type="button" class="btn btn-primary" onclick="execDaumPostcode('employAddress','employAddressDetail')">주소 검색</button>
                                                        </div>
                                                        <!--end::Col-->
                                                    </div>
                                                    <!--end::Row-->
                                                    ...
                                                    <div class="row mt-3">
                                                        <!--begin::Col-->
                                                        <div class="col-lg-12">
                                                            <input type="text" id="employAddressDetail" name="employAddressDetail" class="form-control form-control-lg form-control-solid-bg" value="${info.employAddressDetail}" placeholder="상세주소"/>
                                                        </div>
                                                        <!--end::Col-->
                                                    </div>
                                                    <!--end::Row-->
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <div class="card-footer d-flex justify-content-between py-6 px-9">
                                        <div>
                                            <a href="/mng/board/employment.do" class="btn btn-info btn-active-light-info" id="kt_list_btn">목록</a>
                                        </div>
                                        <div>
                                            <button type="button" onclick="f_board_employment_modify_init_set('${info.seq}')" class="btn btn-danger btn-active-light-danger me-2">변경내용취소</button>
                                            <button type="button" onclick="f_board_employment_save('${info.seq}')" class="btn btn-primary btn-active-light-primary" id="kt_save_submit">변경내용저장</button>
                                        </div>
                                    </div>
                                    <!--end::Actions-->
                                </div>
    ...
    <script src="/js/mng/employment.js?ver=<%=System.currentTimeMillis()%>"></script>
    <!--end::Custom Javascript-->
