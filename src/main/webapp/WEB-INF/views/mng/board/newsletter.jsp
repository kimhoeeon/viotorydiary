...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('mng_board_newsletter_table', '뉴스레터')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_board_newsletter_search()" class="btn btn-primary me-5">Search</button>
                                                <button type="button" onclick="f_board_newsletter_search_condition_init()" class="btn btn-secondary me-5">
                                        ...
                                        <div class="card-toolbar flex-row-fluid gap-5">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="condition_gbn" class="form-select form-select-solid" data-control="select2"
                                                        ...
                                                        data-placeholder="- 공지구분 -" onchange="f_board_newsletter_search()">
                                                    <option></option>
                                            ...
                                            <div class="ms-auto d-flex align-items-center gap-2 gap-lg-3">
                                                ...
                                                <!--begin::등록-->
                                                <a href="javascript:void(0);" onclick="f_board_newsletter_modify_init_set('');" class="btn btn-primary ms-auto">등록</a>
                                                <!--end::등록-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="mng_board_newsletter_table">
                                            <thead>
    ...
    <script src="/js/mng/newsletter.js?ver=<%=System.currentTimeMillis()%>"></script>
