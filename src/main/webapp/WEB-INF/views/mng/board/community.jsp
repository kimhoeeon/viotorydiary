...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('mng_board_community_table', '커뮤니티')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_board_community_search()" class="btn btn-primary me-5">Search</button>
                                                <button type="button" onclick="f_board_community_search_condition_init()" class="btn btn-secondary me-5">
                                        ...
                                        <div class="card-toolbar flex-row-fluid gap-5">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="condition_gbn" class="form-select form-select-solid" data-control="select2"
                                                        ...
                                                        data-placeholder="- 공지구분 -" onchange="f_board_community_search()">
                                                    <option></option>
                                                    <option value="" disabled>- 공지구분 -</option>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="mng_board_community_table">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    <th class="text-center min-w-50px">번호</th>
                                                    <th>seq</th>
                                                    <th class="text-center min-w-100px">공지구분</th>
        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" style="background-color: #1e1e2d;">
                    <!--begin::Modal title-->
                    <h2 style="color: #FFFFFF;">커뮤니티 상세보기</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <div id="md_hashtag" class="form-control form-control-solid-bg"></div>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg mb-2" id="md_recommend_cnt" placeholder="댓글수" readonly>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
    ...
    <!--begin::Modal - 수정이력-->
    <div class="modal fade" id="kt_modal_modify_reply" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            <!--begin::Modal content-->
            <div class="modal-content">
                ...
                <div class="modal-header" style="background-color: #1e1e2d;">
                    <!--begin::Modal title-->
                    <h2 style="color: #FFFFFF;">댓글 정보</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                        <i class="ki-duotone ki-cross fs-1">
