...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                                        ...
                                        <div class="card-toolbar flex-row-fluid gap-5">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="condition_gbn" class="form-select form-select-solid" data-control="select2"
                                                        ...
                                                        data-placeholder="- 공지구분 -" onchange="f_board_notice_search()">
                                                    <option></option>
                                            ...
                                            <div class="ms-auto d-flex align-items-center gap-2 gap-lg-3">
                                                ...
                                                <!--begin::등록-->
                                                <a href="javascript:void(0);" onclick="f_board_notice_modify_init_set('');" class="btn btn-primary ms-auto">등록</a>
                                                <!--end::등록-->
    ...
    <script src="/js/mng/notice.js?ver=<%=System.currentTimeMillis()%>"></script>
