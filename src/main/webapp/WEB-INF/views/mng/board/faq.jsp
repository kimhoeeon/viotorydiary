                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        ...
                                        <div class="card-toolbar flex-row-fluid gap-5">
                                            ...
                                            <div class="w-100 mw-150px">
                                                <!--begin::Select2-->
                                                <select id="condition_exposure_yn" class="form-select form-select-solid" data-control="select2"
                                                        data-hide-search="true" data-allow-clear="true"
                                                        data-placeholder="- 노출구분 -" onchange="f_board_faq_search()">
                                                    <option></option>
                                                    <option value="" disabled>- 노출구분 -</option>
                                            ...
                                            <div class="ms-auto d-flex align-items-center gap-2 gap-lg-3">
                                                ...
                                                <!--begin::등록-->
                                                <a href="javascript:void(0);" onclick="f_board_faq_modify_init_set('');" class="btn btn-primary ms-auto">등록</a>
                                                <!--end::등록-->
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="mng_board_faq_table">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class="text-center min-w-150px">질문</th>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10">
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    <div class="form-check form-check-custom form-check-lg ">
                                        <input class="form-check-input form-control-solid-bg" type="checkbox" id="md_exposure_yn" value="Y" disabled/>
                                        <label class="form-check-label opacity-100 text-black" for="md_exposure_yn">
                                            홈페이지 노출 중
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg mb-2" id="md_question" placeholder="질문" readonly>
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <div id="md_answer" class="form-control form-control-solid-bg resize-none h-250px overflow-y-auto" readonly></div>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
