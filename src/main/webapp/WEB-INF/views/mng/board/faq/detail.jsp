...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <form id="dataForm" method="post" onsubmit="return false;">
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">노출 여부</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8 d-flex flex-wrap">
                                                    <div class="form-check form-check-custom form-check-lg mb-3 mr15">
                                                        <input class="form-check-input form-control-solid-bg" type="checkbox" id="exposureYn" name="exposureYn"
                                                               value="Y" <c:if test="${info.exposureYn eq 'Y'}">checked</c:if>/>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input type="text" id="writer" name="writer" class="form-control form-control-lg form-control-solid-bg" placeholder="${sessionScope.id}" value="${info.writer eq null ? sessionScope.id : info.writer}" readonly/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">질문</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input type="text" id="question" name="question" class="form-control form-control-lg form-control-solid-bg" placeholder="질문" value="${info.question}"/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="row mb-6 h-400px">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">답변</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <div id="quill_editor_content" class="h-350px">${info.answer}</div>
                                                    <input type="hidden" id="quill_content" name="answer" value="<c:out value="${info.answer}" escapeXml="true"/>">
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
    ...
    <script src="/js/mng/faq.js?ver=<%=System.currentTimeMillis()%>"></script>
    <!--end::Custom Javascript-->
