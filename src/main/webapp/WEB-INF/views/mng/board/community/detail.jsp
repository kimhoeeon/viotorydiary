...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <form id="dataForm" method="post" onsubmit="return false;">
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">공지 구분</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8 d-flex flex-wrap">
                                                    <div class="form-check form-check-custom form-check-lg mb-3 mr15">
                                                        <input class="form-check-input form-control-solid-bg"
                                                               type="checkbox" id="gbn" name="gbn"
                                                               <c:if test="${info.gbn eq '1'}">checked</c:if>/>
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">키워드</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input class="form-control form-control-solid" id="hashtag" name="hashtag" placeholder="키워드" value="${info.hashtag}"/>
                                                    <!--begin::Description-->
                                                    <div class="text-muted fs-7">노출되는 순서대로 콤마( , )로 구분하여 작성해주세요.</div>
                                                    <!--end::Description-->
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input type="number" class="form-control form-control-solid" id="recommendCnt" name="recommendCnt" value="${info.recommendCnt eq null ? '0' : info.recommendCnt}"/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    <!--begin::form-->
                                    <form id="dataForm2" method="post" onsubmit="return false;">
                                        <%-- SEQ 값--%>
                                        <input type="hidden" id="userSeq" name="seq" value="${info.seq}">
                                        <!--begin::Card header-->
                                        <div class="card-header border-0">
                                        ...
                                        <div class="card-body border-top p-9">
                                            <!--begin::Input group-->
                                            <div class="row pb-6 border-bottom border-gray-400">
                                                <!--begin::Label-->
                                                <label class="col-lg-2 col-form-label fw-semibold fs-6">MeetingFan</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-10 d-flex justify-content-center align-items-center">
                                                    <div class="col-lg-10">댓글 내용내용내용</div>
                                                    <div class="col-lg-2 text-end">2023.11.30 15:15:00</div>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <div class="card-footer d-flex justify-content-between py-6 px-9">
                                        <div>
                                            <a href="/mng/board/community.do" class="btn btn-info btn-active-light-info" id="kt_list_btn">목록</a>
                                        </div>
                                        <div>
                                            <button type="button" onclick="f_board_community_modify_init_set('${info.seq}')" class="btn btn-danger btn-active-light-danger me-2">변경내용취소</button>
                                            <button type="button" onclick="f_board_community_save('${info.seq}')" class="btn btn-primary btn-active-light-primary" id="kt_save_submit">변경내용저장</button>
                                        </div>
                                    </div>
                                    <!--end::Actions-->
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    ...
                    <div class="col-lg-12 d-flex justify-content-center">
                        ...
                        <div class="ms-10">
                            <!--begin::File upload-->
                            <a onclick="f_attach_file_upload('${info.seq}','modal_file_upload_form','board/community')" class="btn btn-primary">업로드</a>
                            <!--end::File upload-->
                        </div>
                        <!--end::Col-->
                    </div>
    ...
    <script src="/js/mng/community.js?ver=<%=System.currentTimeMillis()%>"></script>
    <!--end::Custom Javascript-->
